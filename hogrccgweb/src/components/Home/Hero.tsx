...
<div className="relative z-10 flex flex-col items-start justify-center h-full text-white px-8">
  <h1 className="xssm:text-5xl text-3xl md:text-7xl lg:text-8xl font-bold mb-4 capitalize font-headingFont xl:w-[80%] xssm:w-[90%] w-[100%]">
    Spreading awareness of God
  </h1>
  <p className="text-[16px] xssm:text-lg md:text-2xl md:w-[80%] w-[90%] font-paragraphFont mb-4">
